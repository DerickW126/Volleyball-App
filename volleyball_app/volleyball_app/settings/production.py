...
PUSH_NOTIFICATIONS_SETTINGS = {
    'APNS_AUTH_KEY_PATH': os.path.join(BASE_DIR, 'volleyball_app', 'APN_Key.p8'),  # Path to your .p8 file
...
# settings.py
cred = credentials.Certificate(os.path.join(BASE_DIR, 'volleyball_app', 'cred.json'))
